...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2021 at 06:31 PM
...
INSERT INTO `chat_history` (`id_chat`, `id_user`, `user_input`, `chatbot_response`, `desc_tag`, `status_desc`, `create_date`, `create_date_time`) VALUES
(3, '1826457406', 'halo', 'halo!, apa yang bisa saya bantu hari  ?', 'salam', NULL, '2021-08-02', '2021-08-02 16:26:16'),
(4, '1826457406', 'saya mau lihat daftar merek yang kamu punya dong', '*1.Alibaba Cloud*\n*2.Cloud Xtream*\n*3.Cyberinc*\n*4.Edgecore Networks*\n*5.Esri*\n*6.Extreme Networks*\n*7.Finisar*\n*8.G Element*\n*9.Hillstone Networks*\n*10.IBM*\n*11.Ignite Net*\n*12.Imperva*\n*13.Lenovo*\n*14.SAS*\n*15.Sensormatic by Johnson Co*\n*16.Varonis*\n', 'daftar merek', 'doing process for retrive_list_brand', '2021-08-02', '2021-08-02 16:26:52'),
(5, '1826457406', 'saya mau liat detail mereknya dong', 'halo!, apa yang bisa saya bantu hari  ?', 'salam', NULL, '2021-08-02', '2021-08-02 16:27:01'),
(6, '1826457406', 'saya mau lihat rincian mereknya dong', '*1.Alibaba Cloud*\n*2.Cloud Xtream*\n*3.Cyberinc*\n*4.Edgecore Networks*\n*5.Esri*\n*6.Extreme Networks*\n*7.Finisar*\n*8.G Element*\n*9.Hillstone Networks*\n*10.IBM*\n*11.Ignite Net*\n*12.Imperva*\n*13.Lenovo*\n*14.SAS*\n*15.Sensormatic by Johnson Co*\n*16.Varonis*\n', 'daftar merek', 'doing process for retrive_list_brand', '2021-08-02', '2021-08-02 16:27:39'),
(7, '1826457406', 'lihat rincian mereknya dong', '*1.Alibaba Cloud*\n*2.Cloud Xtream*\n*3.Cyberinc*\n*4.Edgecore Networks*\n*5.Esri*\n*6.Extreme Networks*\n*7.Finisar*\n*8.G Element*\n*9.Hillstone Networks*\n*10.IBM*\n*11.Ignite Net*\n*12.Imperva*\n*13.Lenovo*\n*14.SAS*\n*15.Sensormatic by Johnson Co*\n*16.Varonis*\n', 'daftar merek', 'doing process for retrive_list_brand', '2021-08-02', '2021-08-02 16:27:53'),
(8, '1826457406', NULL, '*1.Alibaba Cloud*\n*2.Cloud Xtream*\n*3.Cyberinc*\n*4.Edgecore Networks*\n*5.Esri*\n*6.Extreme Networks*\n*7.Finisar*\n*8.G Element*\n*9.Hillstone Networks*\n*10.IBM*\n*11.Ignite Net*\n*12.Imperva*\n*13.Lenovo*\n*14.SAS*\n*15.Sensormatic by Johnson Co*\n*16.Varonis*\n', 'rincian merek', 'giving helper for data id_brand', '2021-08-02', '2021-08-02 16:28:03'),
(9, '1826457406', 'rincian merek', 'please input brand number that you want to know ...', 'rincian merek', 'asking input  id_brand', '2021-08-02', '2021-08-02 16:28:04'),
(10, '1826457406', '2', '*Cloud Xtream*\ncloud computing is the latest major evolution in computing. Cloud Computing involves deploying groups of remote servers and software networks. It allows different kinds of data sources be uploaded for real time processing to generate computing results, without the need to store processed data. Cloud Xtream that provides speed, flexibility, and scalability.\n', 'rincian merek', 'doing process forretrive_desc_brand', '2021-08-02', '2021-08-02 16:28:06');
...
('1826457406', 35, 'my application cant save data', '2021-07-28', NULL, 2, 1),
('1070344922', 39, 'the date of analytics not suit with my request', '2021-07-28', NULL, 3, 1),
('1826457406', 39, 'tiba tiba aplikasi crash muncul code 404', '2021-08-02', '2021-08-02', 3, 0),
('1070344922', 43, 'can not run software, error 8809', '2021-07-30', NULL, 2, 1),
('1826457406', 43, 'hang', '2021-08-01', '2021-08-02', 2, 0);
...
(35, 1, '1826457406', 1111, 10, '2021-07-28', '2021-07-13', '2022-01-22', 1),
(36, 5, '1826457406', 1111, 50, '2021-07-28', '2021-07-06', '2021-07-31', 1),
(37, 39, '1826457406', 1111, 10, '2021-07-28', '2021-07-01', '2021-07-16', 1),
(38, 21, '1826457406', 1111, NULL, '2021-07-28', NULL, NULL, 0),
(39, 34, '1070344922', 1111, 10, '2021-07-28', '2021-07-01', '2021-09-04', 1),
(40, 14, '1070344922', 1111, NULL, '2021-07-28', NULL, NULL, 0),
(41, 32, '1826457406', 1111, NULL, '2021-07-30', NULL, NULL, 0),
(42, 36, '1070344922', 1111, NULL, '2021-07-30', NULL, NULL, 0),
(43, 30, '1070344922', 1111, 5, '2021-07-30', '2021-07-01', '2021-09-04', 1),
(45, 24, '1826457406', 1111, NULL, '2021-08-02', NULL, NULL, 0);
...
INSERT INTO `user` (`id_user`, `name_user`, `email_user`, `phone_number`, `address_user`, `id_company`) VALUES
('1070344922', 'ujang jabbar', 'jabbarujang@gmail.com', '081288884444', 'jalan camar a20/21, kunciran, tangerang', 1111),
('1826457406', 'rievaldy', 'rievaldy3235@gmail.com', '082183248', 'jl.h.jali', 1111);
...
ALTER TABLE `maintenance`
  ...
  ADD KEY `maintenance_ibfk_3` (`id_user`);
...
--
ALTER TABLE `intents`
  MODIFY `id_tag` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `subscribe_product`
  MODIFY `id_subcribe_product` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
ALTER TABLE `maintenance`
  ...
  ADD CONSTRAINT `maintenance_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`);
